...
Breathing is the fastest way to communicate with the vagus nerve, the main highway of the parasympathetic nervous system ("rest and digest").
...
*   **Slow Breathing:** Slowing the breath to about 6 breaths per minute (5.5 seconds in, 5.5 seconds out) maximizes respiratory sinus arrhythmia (RSA), synchronizing heart and lungs. This state of "cardiac coherence" drastically increases [HRV (Heart Rate Variability)](/articoli/longevita/hrv-vo2-rhr-guida), reducing stress and inflammation.

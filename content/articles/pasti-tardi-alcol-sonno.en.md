---
title: "Late Meals and Alcohol: The Silent Enemies of Your Recovery"
description: "Why eating late and having 'just one drink' before bed destroys sleep quality and accelerates aging. The science behind the circadian rhythm."
categories:
  - sonno
  - longevita
  - nutrizione
...
faq:
  - question: "How long before bed should I stop eating?"
    answer: "The golden rule is 3 hours. This allows the stomach to empty and body temperature to drop, a crucial signal for the onset of deep sleep."
  - question: "Doesn't alcohol help you sleep?"
    answer: "No, alcohol is a sedative, not a sleep aid. It makes you lose consciousness faster, but fragments sleep in the second half of the night and suppresses REM sleep, essential for mental health."
  - question: "If I have to eat late, what should I choose?"
    answer: "Avoid heavy carbs and saturated fats that require long digestion. Opt for lean proteins or cooked vegetables. A short post-dinner walk can help accelerate gastric emptying."
cta:
  - text: "Monitor your recovery"
    link: "/articoli/longevita/hrv-vo2-rhr-guida"
    description: "Do you have a wearable? Check how your HRV crashes after a late dinner with alcohol."
tags:
  - sleep
  - alcohol
  - circadian rhythm
...
resources:
  ...
  - name: "Study on Alcohol and REM Sleep"
...
Insulin sensitivity follows a circadian rhythm: it is highest in the morning and lowest in the evening. The same meal that causes a moderate glycemic spike at 1:00 PM can cause prolonged hyperglycemia at 10:00 PM. This excess sugar in the blood during the night inhibits the release of **Growth Hormone (GH)** and melatonin.

#### Thermoregulation and Deep Sleep
To enter deep sleep phases, your core body temperature needs to drop by about 1°C. Digestion is a thermogenic process (it produces heat). By eating late, you keep your body internally "hot," making it physiologically difficult to access regenerative deep sleep.
...
Alcohol is a potent suppressor of REM (Rapid Eye Movement) sleep, the phase where we dream, consolidate emotional memory, and manage stress. Chronic REM deficiency is linked to irritability, anxiety, and difficulty concentrating.
...
**The data proof:** If you wear a tracker (Oura, Whoop, Apple Watch), look at your [HRV](/articoli/longevita/hrv-vo2-rhr-guida) and resting heart rate after drinking. Often HRV crashes by 20-50% and beats stay high all night. Your heart is working overtime while you think you are resting.

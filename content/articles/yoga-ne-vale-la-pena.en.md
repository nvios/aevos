---
title: "Yoga and Longevity: A Scientific Cost-Benefit Analysis"
description: "Yoga is often sold as the solution to everything. But for longevity, is it the best use of your time? Critical analysis of mobility, strength, and more efficient alternatives."
categories:
  - esercizio
  - longevita
...
faq:
  - question: "Does yoga count as strength training?"
    answer: "Only partially and for beginners. It lacks the 'progressive overload' needed to effectively counteract sarcopenia in the long term compared to weights."
  - question: "Does yoga count as cardio?"
    answer: "Generally no. Even intense styles like Vinyasa rarely keep heart rate in Zone 2 or reach VO2 Max peaks sufficient for deep cardiovascular adaptations."
  - question: "If I only have 30 minutes a day, should I do yoga?"
    answer: "It depends on priorities. If you are very stiff and stressed, yes. If you are weak or have low aerobic capacity, a strength circuit or a run is better."
cta:
  - text: "Assess your mobility"
    link: "/servizi/assessment-online"
    description: "Is your flexibility functional or excessive? Find out now."
tags:
  - yoga
  - mobility
  - flexibility
  ...
  - stress
resources:
  - name: "Study on the effects of Yoga on Cortisol"
...
But if your goal is **maximum healthspan extension** and you have limited time, is yoga the best investment (ROI) for your training hours?
...
To prevent [sarcopenia](/articoli/esercizio/sarcopenia-forza-over-50) (age-related muscle loss), weight training (barbells, kettlebells) is objectively superior and more time-efficient.
...
The combination of movement and [conscious breathing](/articoli/longevita/respirazione-biologia-scienza) (pranayama) is a powerful switch to lower [cortisol](/articoli/longevita/cortisolo-stress-cronico).
Clinical studies show that yoga reduces systemic inflammation and improves [HRV](/articoli/longevita/hrv-vo2-rhr-guida) more effectively than simple gymnastics. If your main problem is chronic stress, the ROI of yoga is extremely high.

### What to Do Instead? The Hybrid Approach

If you have 5 hours a week to train, dedicating 5 to yoga is sub-optimal for physical longevity. You would miss key stimuli for the heart ([Zone 2](/articoli/esercizio/zona-2-allenamento-longevita)) and maximal strength.
